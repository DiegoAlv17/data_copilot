// gemini-nl2sql.ts - Módulo para convertir lenguaje natural a SQL usando Gemini

export default class GeminiNL2SQL {
    private apiKey: string;
    private baseUrl: string;
    private realSchemaCache: any;
    private schemaCacheTime: number | null;
    private schemaCacheTimeout: number;
    private mcpToolsUsed: any[];
    private schemaSource: string;
    private emergencySchema: any;
